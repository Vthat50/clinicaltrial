...
class TwoPassExtractor:
    ...
    def generate_sap(self, protocol_text: str, discovered_elements: List[DiscoveredElement] = None,
        ...
        # NOTE: TLF shells are now generated by Claude as part of Section 12 APPENDICES
        # We no longer append generic TLF shells - Claude generates protocol-specific ones
        # The SAP_TEMPLATE includes Section 12.2 Tables, Figures, and Listings Specifications
        # which Claude fills in with actual endpoints, methods, and populations from the protocol
