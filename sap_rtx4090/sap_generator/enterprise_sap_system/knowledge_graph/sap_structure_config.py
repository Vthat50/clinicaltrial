    ...
    SAPSection(
        ...
        subsections=[
            SAPSection("15.1", "PRO Instruments", required=True,
                      description="LIST ALL SYMPTOMS: QLQ-C30 (Fatigue, Pain, Nausea/Vomiting, Dyspnea, Insomnia, Appetite Loss, Constipation, Diarrhea) + EQ-5D-5L (Mobility, Self-Care, Usual Activities, Pain/Discomfort, Anxiety/Depression)",
