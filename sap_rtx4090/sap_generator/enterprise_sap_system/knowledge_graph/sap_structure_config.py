    ...
    SAPSection(
        ...
        subsections=[
            ...
            SAPSection("5A.2", "Baseline Disease Characteristics", required=True,
                      description="ECOG PS, disease stage, time since diagnosis, measurable disease, disease-specific covariates",
    ...
    SAPSection(
        ...
        subsections=[
            SAPSection("11.1", "Pre-specified Subgroups", required=True,
                      description="Subgroups based on baseline covariates (demographics, disease characteristics, prior therapy)",
