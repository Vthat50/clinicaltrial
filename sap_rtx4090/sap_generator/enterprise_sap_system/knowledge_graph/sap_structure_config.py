...
MASTER_SAP_SECTIONS = [
    ...
    SAPSection(
        ...
        kb_tools=["get_sensitivity_analysis", "get_sensitivity_analysis_catalog", "get_reference_sap_section"],
        subsections=[
    ...
    SAPSection(
        ...
        kb_tools=["get_subgroup_analysis_specs", "get_subgroup_specifications", "get_baseline_covariates", "get_reference_sap_section"],
        subsections=[
