...
print("=" * 70)
print("BUILD: v95-2026-01-11")
print("FEATURE: Reference SAP retrieval for RECIST/PRO/Multiplicity content")
print("  • v95: get_reference_sap_section() retrieves from 151 actual SAPs")
print("  • v95: RECIST derivation tables (Table 2/3/4) now available")
print("  • v95: GSHf alpha boundaries now retrievable")
print("  • v95: PRO scoring algorithms with MID thresholds")
print("  • v94: Fix 35 broken KB tool imports")
print("If you don't see v95 in Render logs, Render has OLD code!")
print("=" * 70)
