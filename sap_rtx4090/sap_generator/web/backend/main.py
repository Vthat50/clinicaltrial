...
print("=" * 70)
print("BUILD: v94-2026-01-11")
print("FEATURE: Fix 35 broken KB tool imports")
print("  • v94: Fix relative imports in kb_tools.py (from .comprehensive_sap_elements)")
print("  • v93: SDTM uses Claude + LLMParser")
print("  • v92: LLMParser for robust JSON parsing")
print("  • FIX: All 87 KB tools now functional")
print("If you don't see v94 in Render logs, Render has OLD code!")
print("=" * 70)
