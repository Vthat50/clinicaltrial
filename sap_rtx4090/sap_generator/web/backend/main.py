...
print("=" * 70)
print("BUILD: v43-KG-PIPELINE-DEBUG-2026-01-10")
...
print("  • v43: Added debug logging to trace tool-use loop")
print("  • v43: Continuation prompt when all tools done but no SAP")
print("  • v43: Final generation attempt if max iterations with no text")
